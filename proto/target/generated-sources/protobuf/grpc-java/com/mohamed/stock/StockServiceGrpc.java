...
public final class StockServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.mohamed.stock.StockPriceRequest,
      com.mohamed.stock.StockPriceResponse> getGetStockPriceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetStockPrice",
      requestType = com.mohamed.stock.StockPriceRequest.class,
      responseType = com.mohamed.stock.StockPriceResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.mohamed.stock.StockPriceRequest,
      com.mohamed.stock.StockPriceResponse> getGetStockPriceMethod() {
    io.grpc.MethodDescriptor<com.mohamed.stock.StockPriceRequest, com.mohamed.stock.StockPriceResponse> getGetStockPriceMethod;
      ...
      synchronized (StockServiceGrpc.class) {
        if ((getGetStockPriceMethod = StockServiceGrpc.getGetStockPriceMethod) == null) {
          StockServiceGrpc.getGetStockPriceMethod = getGetStockPriceMethod =
              io.grpc.MethodDescriptor.<com.mohamed.stock.StockPriceRequest, com.mohamed.stock.StockPriceResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetStockPrice"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.mohamed.stock.StockPriceRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.mohamed.stock.StockPriceResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      com.mohamed.stock.PriceUpdate> getGetPriceUpdatesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetPriceUpdates",
      requestType = com.google.protobuf.Empty.class,
      responseType = com.mohamed.stock.PriceUpdate.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      com.mohamed.stock.PriceUpdate> getGetPriceUpdatesMethod() {
    io.grpc.MethodDescriptor<com.google.protobuf.Empty, com.mohamed.stock.PriceUpdate> getGetPriceUpdatesMethod;
      ...
      synchronized (StockServiceGrpc.class) {
        if ((getGetPriceUpdatesMethod = StockServiceGrpc.getGetPriceUpdatesMethod) == null) {
          StockServiceGrpc.getGetPriceUpdatesMethod = getGetPriceUpdatesMethod =
              io.grpc.MethodDescriptor.<com.google.protobuf.Empty, com.mohamed.stock.PriceUpdate>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.mohamed.stock.PriceUpdate.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void getStockPrice(com.mohamed.stock.StockPriceRequest request,
        io.grpc.stub.StreamObserver<com.mohamed.stock.StockPriceResponse> responseObserver) {
    ...
    default void getPriceUpdates(com.google.protobuf.Empty request,
        io.grpc.stub.StreamObserver<com.mohamed.stock.PriceUpdate> responseObserver) {
  ...
  public static final class StockServiceStub
     ...
     * </pre>
     */
    public void getStockPrice(com.mohamed.stock.StockPriceRequest request,
        io.grpc.stub.StreamObserver<com.mohamed.stock.StockPriceResponse> responseObserver) {
  ...
  public static final class StockServiceBlockingStub
     ...
     * </pre>
     */
    public com.mohamed.stock.StockPriceResponse getStockPrice(com.mohamed.stock.StockPriceRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<com.mohamed.stock.PriceUpdate> getPriceUpdates(
  ...
  public static final class StockServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.mohamed.stock.StockPriceResponse> getStockPrice(
        com.mohamed.stock.StockPriceRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_STOCK_PRICE:
          serviceImpl.getStockPrice((com.mohamed.stock.StockPriceRequest) request,
              (io.grpc.stub.StreamObserver<com.mohamed.stock.StockPriceResponse>) responseObserver);
          break;
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.mohamed.stock.StockPriceRequest,
              com.mohamed.stock.StockPriceResponse>(
  ...
  private static abstract class StockServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.mohamed.stock.StockServiceOuterClass.getDescriptor();
    }
