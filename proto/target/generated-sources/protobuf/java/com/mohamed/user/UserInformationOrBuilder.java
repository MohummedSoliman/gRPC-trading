...
public interface UserInformationOrBuilder extends
   ...
   */
  java.util.List<com.mohamed.user.Holding> 
      getHoldingsList();
  /**
   * <code>repeated .user.Holding holdings = 4;</code>
   */
  com.mohamed.user.Holding getHoldings(int index);
  /**
   * <code>repeated .user.Holding holdings = 4;</code>
   */
   ...
   * <code>repeated .user.Holding holdings = 4;</code>
   */
  java.util.List<? extends com.mohamed.user.HoldingOrBuilder> 
      getHoldingsOrBuilderList();
  /**
   * <code>repeated .user.Holding holdings = 4;</code>
   */
  com.mohamed.user.HoldingOrBuilder getHoldingsOrBuilder(
      int index);
}
